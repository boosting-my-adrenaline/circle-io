describe('cq lead 203', () => {
    const url = 'http://localhost:8080/?lead=203&lb=off';
    // const url = 'test.cheaper-quotes.com';
    // const url = 'http://localhost:3000';
    // const url = 'http://apple.com';
    ...
    //         cy.get(`#${input}`).type(text, { delay: 122 });
    ...
    //         cy
    //             .get(`#${input}`)
    //             .should('have.css', 'border', '2px solid rgb(11, 44, 104)');
    //     const checkInputError = (input) =>
    //         cy
    //             .get(`#${input}`)
    //             .should('have.css', 'border', '2px solid rgb(232, 86, 86)');
    ...
    //             // expect(request.body).to.have.property('data.lb', 'off');
    //         }
    //     );
    // });
});
